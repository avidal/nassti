...
TelnetStream.prototype.read_byte = function(ch) {
...
TelnetStream.prototype.read_iac = function(ch) {
  ...
  if(ch === 250) {
    this.telnetBuffer.writeUInt8(ch, this.telnetPtr++);
    return this.read_subneg;
  }
};

TelnetStream.prototype.read_option = function(ch) {
...
TelnetStream.prototype.read_subneg = function(ch) {
